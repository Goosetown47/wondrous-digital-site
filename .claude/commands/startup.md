...
- Read @docs/PRINCIPLES.md to understand our development principles  
- Read @docs/PROCESS.md to understand our workflow and development process
- Read @docs/CODE-CHECKLIST.md for our code quality standards
- Read latest Handoff Notes in `@docs/Handoff_Notes/` to get up to speed on last session. You don't need to read them all, just the one with the most recent date.
...
- Look in docs/Release_Notes/ directory

...
- Read `/home/goosetown/Claude/Projects/wondrous-digital-site/CLAUDE.md` for project-specific AI collaboration guidelines
- Read `/home/goosetown/Claude/Projects/wondrous-digital-site/nextjs-app/docs/PRINCIPLES.md` to understand our development principles
- Read `/home/goosetown/Claude/Projects/wondrous-digital-site/nextjs-app/docs/PROCESS.md` to understand our workflow and development process
- Read `/home/goosetown/Claude/Projects/wondrous-digital-site/nextjs-app/docs/CODE-CHECKLIST.md` for our code quality standards
- Read latest Handoff Notes in `/home/goosetown/Claude/Projects/wondrous-digital-site/nextjs-app/docs/Handoff_Notes/` to get up to speed on last session. You don't need to read them all, just the one with the most recent date.
...
- Look in `/home/goosetown/Claude/Projects/wondrous-digital-site/nextjs-app/docs/Release_Notes/` directory

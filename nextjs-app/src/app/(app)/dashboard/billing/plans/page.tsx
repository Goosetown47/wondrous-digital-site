...
export default function BillingPlansPage() {
  ...
  useEffect(() => {
    ...
    fetchAccountDetails();
  }, [user, currentAccount, router, fetchAccountDetails]);
  ...
  const getYearlyPrice = (tier: TierName): number => {
    ...
    return yearlyPrices[tier as keyof typeof yearlyPrices] || 0;
  };
    ...
    <div className="container mx-auto py-8 max-w-7xl">
      ...
      <div className="grid gap-6 lg:grid-cols-3 mb-8">
        {tiers.map(({ tier, pricing }) => {
          ...
          const tierLevel = TIER_HIERARCHY[tier as keyof typeof TIER_HIERARCHY];
          const currentLevel = TIER_HIERARCHY[currentTier as keyof typeof TIER_HIERARCHY];

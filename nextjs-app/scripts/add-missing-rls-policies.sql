-- Add missing RLS policies for all tables with RLS enabled but no policies
...
-- Public can view published project domains
CREATE POLICY "Public can view published project domains"
...
-- All authenticated users can view published library items
CREATE POLICY "Users can view published library items"
...
-- Inherit policies from library_items
CREATE POLICY "Users can view versions of published items"
...
-- ============================================================================
-- ROLES TABLE POLICIES (if this table exists)
-- ============================================================================

-- Check if roles table exists before creating policies
DO $$
BEGIN
...
-- ============================================================================
-- PERMISSIONS TABLE POLICIES (if this table exists)
-- ============================================================================
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'permissions') THEN
    ...
    EXECUTE 'CREATE POLICY "Users can view their permissions"
    ON public.permissions FOR SELECT
    TO authenticated
    USING (
      role_id IN (
        SELECT role FROM account_users WHERE user_id = auth.uid()
      )
    )';
